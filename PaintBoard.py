...
class PaintBoard(QWidget):
    ...
    def __InitData(self):
        ...
        pklfile = 'tmp/strokes.pkl'
        outfile = open(pklfile,'wb')
        pickle.dump(self.stks, outfile)
        outfile.close()
    ...
    def mouseMoveEvent(self, mouseEvent):
        ...
        self.__currentPos =  mouseEvent.pos()
        self.curx = mouseEvent.pos().x()
        self.cury = mouseEvent.pos().y()
        self.curpos = [self.curx, self.cury]
        self.curstk.append(self.curpos)
        # print(self.curpos)
    ...
    def mouseReleaseEvent(self, mouseEvent):
        ...
        self.stks.append(self.curstk)
        # print(len(self.curstk))
        # self.curstk = []

        pklfile = 'tmp/strokes.pkl'
        outfile = open(pklfile,'wb')
        # pickle.dump(self.stks, outfile)
        pickle.dump(self.curstk, outfile)
        self.curstk = []
        # print(len(self.stks))
        outfile.close()
